// ==========================================
// AGENT: PRODUCT DATABASE MANAGER
// ==========================================
...
const productos = [
    // ===== PANTALLAS PARA EVENTOS =====
    {
        ...
        descripcion: "Ideal para conciertos, conferencias y presentaciones en interiores. Alta definición y fácil montaje.",
    ...
    },
    {
        ...
        categoria: "eventos",
        categoriaLabel: "Eventos",
        descripcion: "Resistente al agua IP65. Perfecta para festivales, eventos deportivos y conciertos al aire libre.",
    ...
    },
    {
        ...
        categoria: "eventos",
        categoriaLabel: "Eventos",
        descripcion: "Pantalla curva flexible para diseños creativos en eventos. Ligera y fácil de transportar.",
    ...
    },
    {
        ...
        categoria: "eventos",
        categoriaLabel: "Eventos",
        descripcion: "Máxima calidad de imagen para eventos premium. Ideal para transmisiones en vivo y producciones de TV.",
    ...
    // ===== PANTALLAS PARA ESCAPARATES =====
    {
        ...
        categoria: "escaparates",
        categoriaLabel: "Escaparates",
        descripcion: "Transparencia del 70%. Perfecta para escaparates de tiendas manteniendo visibilidad interior.",
    ...
    },
    {
        ...
        categoria: "escaparates",
        categoriaLabel: "Escaparates",
        descripcion: "Formato vertical tipo cartel. Ideal para retail y centros comerciales con contenido dinámico.",
    ...
    },
    {
        ...
        categoria: "escaparates",
        categoriaLabel: "Escaparates",
        descripcion: "Con sensor táctil. Permite interacción del cliente con tu catálogo desde el escaparate.",
    ...
    },
    {
        ...
        categoria: "fija",
        categoriaLabel: "Instalación Fija",
        descripción: "Diseñada para estadios deportivos. Gran formato y alto brillo visible desde cualquier ángulo.",
    ...
    modalBody.innerHTML = `
        <div style="padding: 2rem;">
            <div style="display: grid; grid-template-columns: 1fr 1fr; gap: 2rem; margin-bottom: 2rem;">
                ...
                <div>
                    <span style="background: var(--primary-color); color: white; padding: 0.5rem 1rem; border-radius: 20px; font-size: 0.85rem; font-weight: 600;">
                        ${producto.categoriaLabel}
                    </span>
                    <h2 style="margin: 1rem 0; font-size: 2rem;">${producto.nombre}</h2>
                    ...
                    <div style="display: flex; flex-wrap: wrap; gap: 0.5rem; margin-bottom: 2rem;">
                        ${producto.specs.map(spec => `
                            <span style="background: var(--light-gray); padding: 0.5rem 1rem; border-radius: 8px; font-weight: 600;">
                                ${spec}
                            </span>
                        `).join('')}
                    </div>
                    ...
                    <button onclick="addToCart(${producto.id}); closeProductModal();" 
                            style="width: 100%; background: var(--primary-color); color: white; padding: 1rem; border-radius: 10px; font-size: 1.1rem; font-weight: 700; border: none; cursor: pointer; transition: all 0.3s ease;">
            ...
            <div style="background: #f8f9fa; padding: 1.5rem; border-radius: 10px;">
                <h3 style="margin-bottom: 1rem;"><i class="fas fa-info-circle"></i> Información Adicional</h3>
